...
class TripartiteSupplierController extends AdminController {
    ...
    {
        $grid = new Grid(new Tripartite_supplier());
    ...
    {
        $form = new Form(new Tripartite_supplier());
...
//        $form->text('company_title', '广告标题');
    ...
    {
        $businessModel = new Tripartite_supplier();
