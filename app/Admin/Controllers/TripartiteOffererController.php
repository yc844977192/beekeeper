...
use App\Models\Tripartite_offerer;
...
class TripartiteOffererController extends AdminController {
    ...
    {
        $grid = new Grid(new Tripartite_offerer());
    ...
    {
        $form = new Form(new Tripartite_offerer());
...
//        $form->text('company_title', '广告标题');
    ...
    {
        $businessModel = new Tripartite_offerer();
