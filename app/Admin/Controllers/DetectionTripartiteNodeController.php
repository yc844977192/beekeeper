...
use App\Models\DetectionTripartiteNode;
...
class DetectionTripartiteNodeController extends AdminController {
    ...
    {
        $grid = new Grid(new DetectionTripartiteNode());
        ...
        $grid->column('123', '今日数量')
            ->display(function() {
                ...
                $count=DB::table("detection_snapshot")
    ...
    {
        $form = new Form(new DetectionTripartiteNode());
