                ...
                <div class="line-3-search">
                    ...
                    <div class="search-keywords-tu" id="detection_gather">
                        <script type="text/javascript">
                            ...
                            var rubbings_query_times=<?php echo stripslashes($rubbings_query_times);?>;
                            var rubbings_query_total=<?php echo stripslashes($rubbings_query_total);?>;
                            // 指定图表的配置项和数据
                            var option = {
                                xAxis: {
                                    type: 'category',
                                    data: rubbings_query_times,
                                    name: 'x',
